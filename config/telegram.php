...
return [
    'bots' => [
        'MensaScolasticaRoma' => [
            ...
            'webhook_url' => env('APP_URL') . '/tg/' . env('TELEGRAM_BOT_TOKEN') . '/webhook',
            /*
            ...
            'commands' => [
                ...
                \App\Telegram\Commands\Aggiungi::class,
                \App\Telegram\Commands\Rimuovi::class,
    ...
    */
    'commands' => [
        \App\Console\Commands\Help::class,
    ],
